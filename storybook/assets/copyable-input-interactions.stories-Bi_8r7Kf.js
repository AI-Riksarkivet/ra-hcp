import{i as e}from"./preload-helper-xPQekRTU.js";import{Ot as t,hn as n,jt as r,rt as i,sn as a,t as o,tt as s,vn as c}from"./client-DASBvjj6.js";import{n as l,rt as u,t as d}from"./iframe-BxaPFNW1.js";import{n as f,t as p}from"./copyable-input-CPA95LNG.js";function m(e){l(e,{children:(e,n)=>{var i=h(),o=t(i);p(o,{value:`urn:hcp:namespace:production-data`,label:`Canonical ID`});var c=r(o,2);p(c,{value:`sk_live_abc123secret456def789`,label:`Secret Key`,secret:!0}),p(r(c,2),{value:`https://hcp.example.com:8000`}),a(i),s(e,i)},$$slots:{default:!0}})}var h,g=e((()=>{c(),u(),n(),o(),f(),d(),h=i(`<div class="max-w-md space-y-6 p-4"><!> <!> <!></div>`),m.__docgen={data:[],name:`copyable-input-test-harness.svelte`}})),_,v,y,b,x,S,C,w;e((()=>{g(),{expect:_,userEvent:v,within:y}=__STORYBOOK_MODULE_TEST__,b={title:`Tests/CopyableInput Interactions`,component:m,tags:[`!autodocs`]},x={play:async({canvasElement:e})=>{let t=y(e);await _(t.getByText(`Canonical ID`)).toBeInTheDocument(),await _(t.getByText(`Secret Key`)).toBeInTheDocument(),await _(t.getAllByRole(`textbox`).length).toBeGreaterThanOrEqual(2)}},S={play:async({canvasElement:e})=>{let t=y(e);await _(e.querySelectorAll(`input[type="password"]`).length).toBe(1);let n=y(t.getByText(`Secret Key`).closest(`.space-y-1`)).getAllByRole(`button`)[0];await v.click(n),await _(e.querySelectorAll(`input[type="password"]`).length).toBe(0),await v.click(n),await _(e.querySelectorAll(`input[type="password"]`).length).toBe(1)}},C={play:async({canvasElement:e})=>{let t=y(y(e).getByText(`Canonical ID`).closest(`.space-y-1`)).getAllByRole(`button`)[0];await v.click(t),await _(t).toBeInTheDocument()}},x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`{
  play: async ({
    canvasElement
  }) => {
