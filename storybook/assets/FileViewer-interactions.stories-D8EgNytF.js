import{c as q,f as $,b as z,d as w,I as O,j as U,h as a,i as I,v as h,g as Z,s as H,m as b,F as L,l as B,k,w as _,N as R}from"./iframe-DgApCNWx.js";import{F as G}from"./FileViewer-6eJtGvO4.js";import{T as Y}from"./tooltip-provider-Bco1C0TD.js";import"./preload-helper-PPVm8Dsz.js";import"./Icon-CF0m7xwd.js";import"./legacy-BBHXKvC7.js";import"./cn-BrOejGsg.js";import"./dialog-description-BmKEYWkP.js";import"./scroll-lock-D3XV20NK.js";import"./is-DfNA0v5i.js";import"./create-id-B6t2doc_.js";import"./dialog-description-CpnIrX9K.js";import"./x-B_51FQRW.js";import"./button-HcKLGj6z.js";import"./index-6Z4uL6vp.js";import"./badge-BZ7ZBtQN.js";import"./chevron-right-o-A2pww_.js";import"./info-Cy26y1cy.js";import"./loader-circle-Dy4YOtGK.js";import"./popper-layer-force-mount-BH1whsdN.js";var J=k('<button data-testid="reopen-btn">Reopen</button>'),Q=k('<div class="p-4"><!> <div data-testid="current-file" class="text-xs text-muted-foreground"> </div> <!></div>');function N(e){let t=_(!0),o=_(0);const i=[{filename:"photo-001.jpg",url:"https://placehold.co/400x300/1a1a2e/eee?text=Photo+001",size:245760,objectKey:"photos/photo-001.jpg",lastModified:"2024-11-15T10:30:00Z",etag:'"abc123"',storageClass:"STANDARD"},{filename:"photo-002.png",url:"https://placehold.co/400x300/2d3436/dfe6e9?text=Photo+002",size:512e3,objectKey:"photos/photo-002.png",lastModified:"2024-11-16T14:00:00Z",etag:'"def456"',storageClass:"STANDARD"},{filename:"data-export.parquet",url:"#",size:52428800,objectKey:"exports/data-export.parquet",lastModified:"2024-12-01T08:00:00Z",storageClass:"GLACIER"}];let s=B(()=>i[a(o)]);function C(){a(o)>0&&R(o,-1)}function j(){a(o)<i.length-1&&R(o)}var T=q(),E=$(T);z(E,()=>Y,(F,P)=>{P(F,{children:(S,W)=>{var x=Q(),v=b(x);{var A=c=>{var f=J();L("click",f,()=>h(t,!0)),w(c,f)};U(v,c=>{a(t)||c(A)})}var D=I(v,2),K=b(D),M=I(D,2);{let c=B(()=>a(o)>0),f=B(()=>a(o)<i.length-1);G(M,{get filename(){return a(s).filename},get url(){return a(s).url},get size(){return a(s).size},get objectKey(){return a(s).objectKey},get lastModified(){return a(s).lastModified},get etag(){return a(s).etag},get storageClass(){return a(s).storageClass},get hasPrev(){return a(c)},get hasNext(){return a(f)},onprev:C,onnext:j,onclose:()=>h(t,!1),get currentIndex(){return a(o)},get totalCount(){return i.length},get open(){return a(t)},set open(V){h(t,V,!0)}})}Z(()=>H(K,a(s).filename)),w(S,x)},$$slots:{default:!0}})}),w(e,T)}O(["click"]);N.__docgen={data:[],name:"FileViewer-test-harness.svelte"};const{expect:n,userEvent:r,within:y}=__STORYBOOK_MODULE_TEST__,ye={title:"Tests/FileViewer Interactions",component:N,tags:["!autodocs"]};function m(){return y(document.body)}const p={play:async()=>{const e=m();await n(await e.findByRole("heading",{name:"photo-001.jpg"})).toBeInTheDocument(),await n(await e.findByText("1 of 3")).toBeInTheDocument(),await n(await e.findByText("240.0 KB")).toBeInTheDocument(),await n(await e.findByText("STANDARD")).toBeInTheDocument()}},l={play:async({canvasElement:e})=>{const t=m(),o=y(e),i=await t.findByRole("button",{name:"Next file"});await r.click(i),await n(await t.findByRole("heading",{name:"photo-002.png"})).toBeInTheDocument(),await n(await t.findByText("2 of 3")).toBeInTheDocument(),await n(o.getByTestId("current-file")).toHaveTextContent("photo-002.png")}},d={play:async()=>{const e=m(),t=await e.findByRole("button",{name:"Next file"});await r.click(t),await r.click(t),await n(await e.findByRole("heading",{name:"data-export.parquet"})).toBeInTheDocument(),await n(await e.findByText(/Preview not available/)).toBeInTheDocument(),await n(await e.findByText("3 of 3")).toBeInTheDocument()}},g={play:async()=>{const e=m();await n(await e.findByText("Details")).toBeInTheDocument(),await n(await e.findByText("photos/photo-001.jpg")).toBeInTheDocument();const t=await e.findByRole("button",{name:"Toggle metadata"});await r.click(t),await n(e.queryByText("Details")).not.toBeInTheDocument(),await r.click(t),await n(await e.findByText("Details")).toBeInTheDocument()}},u={play:async({canvasElement:e})=>{const t=m(),o=y(e);await n(await t.findByRole("heading",{name:"photo-001.jpg"})).toBeInTheDocument();const i=await t.findByRole("button",{name:"Close"});await r.click(i),await n(await o.findByTestId("reopen-btn")).toBeInTheDocument()}};p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
  play: async () => {
    const page = getPage();
...
}`,...u.parameters?.docs?.source},description:{story:"Close the viewer dialog.",...u.parameters?.docs?.description}}};const Te=["RendersFirstFile","NavigateNext","UnsupportedFileType","ToggleMetadata","CloseViewer"];export{u as CloseViewer,l as NavigateNext,p as RendersFirstFile,g as ToggleMetadata,d as UnsupportedFileType,Te as __namedExportsOrder,ye as default};
