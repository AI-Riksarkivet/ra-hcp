import{q as w,d as m,a as g,m as B,k as x}from"./iframe-DFtYtFsL.js";import"./legacy-D7OnDY3G.js";import{C as d}from"./copyable-input-2CYlDEcJ.js";import"./preload-helper-PPVm8Dsz.js";import"./button-BbjatG8g.js";import"./index-KRrpyZZM.js";import"./this-Dypaan2Q.js";import"./input-Btbn_eAX.js";import"./input-BYhCp0Wp.js";import"./label-mrAA5l7e.js";import"./use-copy-feedback.svelte-BIkLQfhP.js";import"./Icon-CYtk7mac.js";import"./each-BlWt3Neu.js";import"./check-rNiRaSFp.js";var T=x('<div class="max-w-md space-y-6 p-4"><!> <!> <!></div>');function h(e){w(e,{children:(t,o)=>{var s=T(),c=B(s);d(c,{value:"urn:hcp:namespace:production-data",label:"Canonical ID"});var a=m(c,2);d(a,{value:"sk_live_abc123secret456def789",label:"Secret Key",secret:!0});var u=m(a,2);d(u,{value:"https://hcp.example.com:8000"}),g(t,s)},$$slots:{default:!0}})}h.__docgen={data:[],name:"copyable-input-test-harness.svelte"};const{expect:n,userEvent:y,within:p}=__STORYBOOK_MODULE_TEST__,F={title:"Tests/CopyableInput Interactions",component:h,tags:["!autodocs"]},r={play:async({canvasElement:e})=>{const t=p(e);await n(t.getByText("Canonical ID")).toBeInTheDocument(),await n(t.getByText("Secret Key")).toBeInTheDocument();const o=t.getAllByRole("textbox");await n(o.length).toBeGreaterThanOrEqual(2)}},i={play:async({canvasElement:e})=>{const t=p(e),o=e.querySelectorAll('input[type="password"]');await n(o.length).toBe(1);const c=t.getByText("Secret Key").closest(".space-y-1"),u=p(c).getAllByRole("button")[0];await y.click(u);const b=e.querySelectorAll('input[type="password"]');await n(b.length).toBe(0),await y.click(u);const v=e.querySelectorAll('input[type="password"]');await n(v.length).toBe(1)}},l={play:async({canvasElement:e})=>{const s=p(e).getByText("Canonical ID").closest(".space-y-1"),a=p(s).getAllByRole("button")[0];await y.click(a),await n(a).toBeInTheDocument()}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  play: async ({
    canvasElement
  }) => {
