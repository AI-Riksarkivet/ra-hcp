import{i as e}from"./preload-helper-xPQekRTU.js";import{H as t,It as n,Ot as r,Qt as i,Rt as a,Zt as o,a as s,hn as c,ht as l,jt as u,kt as d,o as f,rt as p,sn as m,t as h,tt as g,vn as _}from"./client-DASBvjj6.js";import{B as v,Pt as y,X as b,c as x,i as S,n as C,nt as w,o as T,p as E,v as D}from"./lucide-svelte-B2icGTJZ.js";import{n as O,t as k}from"./cors-editor-CH0sMLWk.js";import{n as A,t as j}from"./dist-X8tzecH4.js";import{i as M,t as N}from"./dist-CDIm6bJO.js";function P(e,t){i(t,!0);let n=s(t,F);A(e,f({get theme(){return M.current},class:`toaster group`,style:`--normal-bg: var(--color-popover); --normal-text: var(--color-popover-foreground); --normal-border: var(--color-border);`},()=>n,{loadingIcon:e=>{b(e,{class:`size-4 animate-spin`})},successIcon:e=>{y(e,{class:`size-4`})},errorIcon:e=>{v(e,{class:`size-4`})},infoIcon:e=>{w(e,{class:`size-4`})},warningIcon:e=>{D(e,{class:`size-4`})},$$slots:{loadingIcon:!0,successIcon:!0,errorIcon:!0,infoIcon:!0,warningIcon:!0}})),o()}var F,I=e((()=>{_(),c(),h(),T(),x(),E(),S(),C(),j(),N(),F=new Set([`$$slots`,`$$events`,`$$legacy`]),P.__docgen={data:[{name:`invert`,visibility:`public`,description:`Dark toasts in light mode and vice versa.`,keywords:[],kind:`let`,type:{kind:`type`,type:`boolean`,text:`boolean`},static:!1,readonly:!1},{name:`theme`,visibility:`public`,description:`Toast's theme, either light, dark, or system.
