import{i as m,d as w,k as g,j as B}from"./iframe-B_Hdbjk-.js";import"./legacy-DDH8hbPc.js";import{C as d}from"./copyable-input-CSJp6WwV.js";import{T as x}from"./tooltip-provider-Dq-XrrsP.js";import"./preload-helper-C3D6FIzC.js";import"./button-DzyUnO0f.js";import"./cn-_yov3II5.js";import"./index-DW9qdgWl.js";import"./this-CckC6naJ.js";import"./input-BQ9TUkQf.js";import"./input-BmNEgVkw.js";import"./label-DqDzqboX.js";import"./create-id-D72_QhI0.js";import"./check-C3Fg1b1K.js";import"./Icon-DV1z99gs.js";import"./each-Cqpn97EE.js";import"./popper-layer-force-mount-LJG7RPBr.js";import"./scroll-lock-CpRMjW-3.js";import"./is-BN3pKCHL.js";var T=B('<div class="max-w-md space-y-6 p-4"><!> <!> <!></div>');function h(e){x(e,{children:(t,o)=>{var s=T(),c=g(s);d(c,{value:"urn:hcp:namespace:production-data",label:"Canonical ID"});var a=m(c,2);d(a,{value:"sk_live_abc123secret456def789",label:"Secret Key",secret:!0});var u=m(a,2);d(u,{value:"https://hcp.example.com:8000"}),w(t,s)},$$slots:{default:!0}})}h.__docgen={data:[],name:"copyable-input-test-harness.svelte"};const{expect:n,userEvent:y,within:p}=__STORYBOOK_MODULE_TEST__,j={title:"Tests/CopyableInput Interactions",component:h,tags:["!autodocs"]},r={play:async({canvasElement:e})=>{const t=p(e);await n(t.getByText("Canonical ID")).toBeInTheDocument(),await n(t.getByText("Secret Key")).toBeInTheDocument();const o=t.getAllByRole("textbox");await n(o.length).toBeGreaterThanOrEqual(2)}},i={play:async({canvasElement:e})=>{const t=p(e),o=e.querySelectorAll('input[type="password"]');await n(o.length).toBe(1);const c=t.getByText("Secret Key").closest(".space-y-1"),u=p(c).getAllByRole("button")[0];await y.click(u);const b=e.querySelectorAll('input[type="password"]');await n(b.length).toBe(0),await y.click(u);const v=e.querySelectorAll('input[type="password"]');await n(v.length).toBe(1)}},l={play:async({canvasElement:e})=>{const s=p(e).getByText("Canonical ID").closest(".space-y-1"),a=p(s).getAllByRole("button")[0];await y.click(a),await n(a).toBeInTheDocument()}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  play: async ({
    canvasElement
  }) => {
