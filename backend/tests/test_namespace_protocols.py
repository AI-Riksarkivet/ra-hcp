"""Tests for namespace protocol configuration endpoints (REST, NFS, CIFS, SMTP)."""
...
NS_PATH = f"{HCP_BASE}/tenants/my-tenant/namespaces/my-ns"
API_BASE = "/api/v1/mapi/tenants/my-tenant/namespaces/my-ns"
